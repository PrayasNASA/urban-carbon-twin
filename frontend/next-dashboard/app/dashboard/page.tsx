...
export default function Dashboard() {
    ...
    return (
        <main className="min-h-screen overflow-y-auto overflow-x-hidden scroll-smooth grain-overlay relative bg-background">
            <HeatmapBackground scrollProgress={null} />

            <section className="min-h-screen w-screen relative z-20 bg-transparent text-gray-50 antialiased font-sans">
                {/* 🏛️ Solarpunk Header */}
