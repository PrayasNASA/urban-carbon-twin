  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="p-8 glass-panel !border-white/10 bg-white/10 rounded-2xl shadow-xl">
        ...
        <div className="p-8 bg-neon-emerald/20 border border-neon-emerald/30 rounded-2xl relative overflow-hidden group shadow-xl">
        ...
        <div className="p-8 glass-panel !border-white/10 bg-white/5 rounded-2xl flex flex-col justify-center">
      ...
      <div className="space-y-6">
        ...
        {plan.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {plan.map((p: any, idx: number) => (
              <motion.div
                ...
                className="p-8 glass-panel !bg-black/40 border border-white/15 rounded-2xl hover:border-neon-emerald/60 transition-all group/row cursor-pointer relative overflow-hidden shadow-lg h-full flex flex-col justify-between"
              >
          ...
          <div className="h-64 glass-panel !bg-white/5 border border-dashed border-white/10 rounded-3xl flex flex-col items-center justify-center text-white/20 gap-4">
